...
const ConfirmRidePopUp = (props) => {
    ...
    const submitHander = async (e) => {
        e.preventDefault()
        // Dummy function for now - backend integration pending
        ...
        // navigate('/captain-riding', { state: { ride: props.ride } }) - navigation pending
    }
        ...
        <div>
            ...
            <div className='flex items-center justify-between p-3 border-2 border-yellow-400 rounded-lg mt-4'>
                <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='text-lg font-medium capitalize'>Rahul Sharma</h2>
                </div>
